...
PortfolioChartView.prototype.bindEvents = function(){
  ...
  PubSub.subscribe('ThemeSelect:theme-selected', (event) => {
    this.themeName = event.detail;
    this.render();
  })

};

PortfolioChartView.prototype.getChartTheme = function(theme){
...
PortfolioChartView.prototype.render = function(){
  ...
  Highcharts.theme = this.getChartTheme(this.themeName);
  // Apply the theme
